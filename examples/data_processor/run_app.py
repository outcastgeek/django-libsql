...
def cleanup():
    """Run cleanup command."""
    print("\n🧹 Cleaning up processor app data...")
    try:
        call_command('cleanup_processor')
...
if __name__ == "__main__":
    ...
    if os.environ.get('RUN_MAIN') != 'true':
        ...
        try:
            call_command('create_processor_data')
        except Exception as e:
    ...
    execute_from_command_line(['manage.py', 'runserver', '--noreload', '8002'])
